pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/gonzalkb/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('gonzalkb-225')   // <---- Change this to match your kubernetes cluster credentials
    }
